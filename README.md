...
Les prévisions financières vont varier énormément selon les phases de l'entreprise, puis selon les hypothèses.
Ce document présente les résultat de la feuille de calcul des prévisions financières.

Phases


Preuve de concept (1 employé)
Recherche et développement (5 employés)
Production de machine bêta (10 employés)
Production de masse (200 employés)

Hypothèses

Tous les calculs sont basées sur certaines hypothèses émises. Le but est de minimiser le nombre d'hypothèse et de s'assurer qu'elle soit le plus précise possible.
Changer les hypothèses modifie tous les calculs.

<h1>Prévisions financières</h1>


<h2>Enregistrement aux taxes</h2>

De manière générale, toute personne doit s'inscrire aux fichiers de la TPS et de la TVQ si elle exerce des activités commerciales au Québec.

Plus précisément, vous devez vous inscrire aux fichiers de la TPS et de la TVQ si le total de vos fournitures taxables (y compris les ventes, les locations, les échanges, les transferts, le troc, etc.) effectuées à l'échelle mondiale ainsi que celles de vos associés excède 30 000 $ au cours d'un trimestre civil donné ou pour l'ensemble des quatre trimestres civils qui le précèdent.

Pour savoir comment inscrire votre entreprise aux fichiers de la TPS/TVH et de la TVQ, consultez la page Comment vous inscrire aux fichiers de la TPS et de la TVQ

https://www.revenuquebec.ca/fr/entreprises/taxes/tpstvh-et-tvq/inscription-aux-fichiers-de-la-tps-et-de-la-tvq/


TODO:
- Calculer coût de production robot de table Heda
- Calculer le coût de recherche et développement nécessaire.

Ce plan est une prévision financière de 5 ans. La compagnie devra passer
 par les phases de preuves de concept, recherche et développement, 
production minimale et production de masse. Ce document prévoit 
seulement le modèle de 
base, le robot de table Heda, puisqu'il sera le focus principal de la 
compagnie jusqu'à la production de masse.

<h2>Revenus</h2>

Prévente kick-starter de robots de table. Prévision 75 robots vendus à 
2000$ et 1000$ obtenu en soutien.
Émissions d'actions. 30% de la compagnie pour un million de dollars.
Subventions. Recherche et développement qui paie une partie du salaire 
des employés.

Si je n'arrive pas à vendre à des particuliers pour l'instant, je vais 
...
Quelle personnalité souhaitez vous pour le formulaire?
...
Je ne sais pas pourquoi les images ne s'affichent plus, mais elle sont dans le dossier heda-recipes/old_designs
...
Je trouve que mes bénéfices sont négatifs. Trouver une tournure positive.
----------
...
Faire une alliance avec des paniers de fruits et légumes bios. Planifier des recettes avec ce qu'il y a dans la boite.
...
Les pâtes fraîches je trouve sont un bon exemple:
